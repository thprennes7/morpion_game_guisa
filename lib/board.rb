...
class Board
  ...
  def check_board(player_symbol)
    ...
    if (flattened_board[:a1] == player_symbol && flattened_board[:b2] == player_symbol && flattened_board[:c3] == player_symbol) || (flattened_board[:a3] == player_symbol && flattened_board[:b2] == player_symbol && flattened_board[:c1] == player_symbol) || (flattened_board[:a1] == player_symbol && flattened_board[:b1] == player_symbol && flattened_board[:c1] == player_symbol) || (flattened_board[:a2] == player_symbol && flattened_board[:b2] == player_symbol && flattened_board[:c2] == player_symbol) || (flattened_board[:a3] == player_symbol && flattened_board[:b3] == player_symbol && flattened_board[:c3] == player_symbol) || (flattened_board[:a1] == player_symbol && flattened_board[:a2] == player_symbol && flattened_board[:a3] == player_symbol) || (flattened_board[:b1] == player_symbol && flattened_board[:b2] == player_symbol && flattened_board[:b3] == player_symbol) || (flattened_board[:c1] == player_symbol && flattened_board[:c2] == player_symbol && flattened_board[:c3] == player_symbol)
      return true
    else
      return false
    end
